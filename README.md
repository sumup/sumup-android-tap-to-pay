...
- a secret API key (used for the authentication process). You can generate a Secret API key in the [SumUp Dashboard](https://developer.sumup.com/online-payments/introduction/authorization#api-keys)
...
It is possible to use a provided API key as an auth token, or generate a new one in the [SumUp Dashboard](https://developer.sumup.com/online-payments/introduction/authorization#api-keys) and provide it to the SDK.
